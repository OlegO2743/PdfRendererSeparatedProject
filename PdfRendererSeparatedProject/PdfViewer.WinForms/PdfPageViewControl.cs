...
internal sealed class PdfPageViewControl : Control
{
    ...
    public Size PagePixelSize { get; private set; } = new(1, 1);

    public bool HasRenderedBitmap => _bitmap != null;

    public PdfPageViewControl()
    {
        DoubleBuffered = true;
    ...
    public void SetPagePixelSize(Size pagePixelSize)
    {
        PagePixelSize = new Size(Math.Max(1, pagePixelSize.Width), Math.Max(1, pagePixelSize.Height));
        Size = PagePixelSize;
        Invalidate();
    }
    ...
    public void UpdateHoveredObject(Point localPoint)
    {
        ...
        int newIndex = FindObjectAt(localPoint);
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        RectangleF highlightBounds = _objects[_hoveredObjectIndex].Bounds;
    ...
    private int FindObjectAt(Point localPoint)
    {
